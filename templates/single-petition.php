...
$goal = get_post_meta(get_the_ID(), 'petition_goal', true );
...
<div class="petition">
    <div class="petition--header">
        ...
        ?>
                ...
                <!-- <select class="languages-tab pt30">
                    <option class="<?= $petition_id == get_the_ID() ?'active':''?>"><a href="<?= get_the_permalink($petition_id) ?>">Português</a></option>
                    ...
                    foreach($petition_children as $p_child){
                        ...
                        if(count($languages) > 0){
                            ?>
                                <option class="<?= $p_child->post_id == get_the_ID() ?'active':''?>"><a href="<?= get_the_permalink($p_child->post_id) ?>"><?= $languages[0]->name ?></a></option>
                            <?php
                        }
                    }
                    ?>
                    ...
                    <div class="signatures-information">
                        <div class="signatures-count">
                            ...
                            <?php if($goal): ?>
                                <div class="progress">
                                    <?php 
                                        $complete = $signatures_count / $goal;
                                    ?>
                                    <div class="progress-bar" style="width: <?= $complete ?>">
